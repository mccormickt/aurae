...
macros::subcommand!(
    ...
    Allocate {
        ...
        machine_root_drive_image_path[long, alias = "root-drive-path", default_value = ""],
        ...
        machine_network_tap_device[long, alias = "tap-device", default_value = ""],
        machine_network_mac_address[long, alias = "mac-address", default_value = ""],
    },
    Free {
        vm_id[required = true],
    },
